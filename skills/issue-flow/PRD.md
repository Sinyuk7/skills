...
Status: Draft
Owner: Skills repo
Scope: Workflow namespace plus three stage entry skills
...
The shared logic lives in `skills/issue-flow/`.
...
7. `analysis/handoff.xml` carries the concise downstream summary, while
   ...
   externally handed off, or closed as non-actionable.
